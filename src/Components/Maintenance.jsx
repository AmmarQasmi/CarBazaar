...
function Maintenance() {
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-600 via-gray-500 to-gray-300 flex items-center justify-center">
      <div className="bg-white p-10 rounded-lg shadow-xl w-full max-w-4xl mx-auto grid grid-cols-1 gap-6 mt-20 mb-20">
