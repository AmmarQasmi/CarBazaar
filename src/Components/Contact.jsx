                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center items-center">
                    ...
                    <form onSubmit={handleSubmit} className="w-full">
                        <input 
                            ...
                            placeholder="Subject" 
                            className="w-full mb-4 p-3 bg-gray-200 border border-transparent rounded-md focus:border-red-500 focus:bg-white outline-none" 
                            required
                        />
                        <input 
                            type="text" 
                        ...
                        <textarea 
                            ...
                            onChange={handleChange}
                            placeholder="Message" 
                            className="w-full mb-6 p-3 bg-gray-200 border border-transparent rounded-md focus:border-red-500 focus:bg-white outline-none min-h-[120px] resize-none"
                            required
                        ></textarea>
                        <button 
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-3 text-lg font-medium text-white bg-red-500 rounded-md hover:bg-red-600 transition duration-300 disabled:opacity-50"
                        >
