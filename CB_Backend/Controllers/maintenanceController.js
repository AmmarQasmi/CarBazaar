...
exports.maintenanceController = async (req, res) => {
    ...
    try {
      ...
      const subjectUser = "Maintenance Registration Confirmation";
      const textUser = `Hello, your maintenance request has been registered successfully. Service Details:
      - Date: ${service_date}
      ...
      const subjectCompany = "New Maintenance Request Submitted";
      const textCompany = `A new maintenance request has been submitted. Details:
      - User Email: ${email}
      - Date: ${service_date}
      - Description: ${service_description}
      - Cost: ${cost}
      ...
      const htmlCompany = `
        ...
        <p>A new maintenance request has been submitted. Below are the details:</p>
        <ul>
      ...
      res.status(201).json({
        status: "success",
        message: "Maintenance record created successfully. Emails sent to user and company.",
